...
function submitUpdateArticle(ArticleID) { 
	"use strict";
	...
	if (check === false) {
		...
		$.post('process_update_article.php', {
			"ArticleID": ArticleID,
			"Title": title.value,
			...
			if (response.substring(0, 9) === "Updated: ") {
				form_feedback.style.color = "#0094cc";
				form_feedback.innerHTML = "Your article has been updated successfully. Redirecting to the article...";
